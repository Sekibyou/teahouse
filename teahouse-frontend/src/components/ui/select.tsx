  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        position={position}
        className={cn(
          "relative z-50 max-h-(--radix-select-content-available-height) min-w-36 origin-[--radix-select-content-transform-origin] overflow-x-hidden overflow-y-auto rounded-lg bg-popover text-popover-foreground shadow-lg shadow-foreground/10 ring-1 ring-foreground/15 dark:shadow-black/60 dark:ring-foreground/25",
          position === "popper" &&
