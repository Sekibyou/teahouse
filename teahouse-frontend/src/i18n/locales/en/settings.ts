...
If the template omits \${teahouse.user_input}, the engine auto-appends a divider note plus the raw user line. The wrapper exists only for that request — history always stores the raw user input.`,
  ...
  plugin: {
    ...
    importGit: "Import from Git",
    gitUrlPH: "Paste a git repo URL, e.g. https://github.com/xxx/xxx.git",
    errGitPreview: "Failed to fetch git repository",
    fromGit: "From Git",
    sourceCustom: "Custom plugin",
    update: "Update",
    updateTitle: "Update plugin",
    updateBtn: "Confirm update",
    upToDate: "Already the latest version v{{version}}",
    errUpdate: "Update failed",
